const SectionLayout = ({ title, description, children, widget }) => {
  return (
    <div className="w-full text-left">
        ...
        <div className="flex flex-row items-start justify-between">
          <div>
            ...
            <div className="w-full mt-6">
              <span className="text-2xl font-monaspace_neon bg-gradient-to-br from-theme1Color1 via-theme1Color2 to-theme1Color3 bg-clip-text text-transparent">
                {title}
              </span>
            </div>
          </div>
      ...
      {description && (
        <div className="mt-6 text-theme1Color2 text-sm md:text-base">{description}</div>
      )}
