...
const IndexIntro = () => {
  ...
  const paragraphs = [
    ...
    "We are at the forefront of a new AGI wave. With over 10,000 total attendees, 200 speakers, 1,500 startups, 2,000 founders/CEOs, 20 international media outlets, and more than 3,000 developers, the summit brings together the world's most cutting-edge entrepreneurial teams, corp decision makers, and investment institutions to jointly explore the future of this field.",
  ];
  const images = [
