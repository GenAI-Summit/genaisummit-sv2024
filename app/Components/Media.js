      ...
      <div className="w-full flex flex-wrap mt-12 items-center gap-x-[4%] md:gap-x-[4%] lg:gap-x-[2%] gap-y-6 md:gap-y-8 lg:gap-y-4 justify-start">
        {media.map((item) => (
          <Link
            ...
            href={item.url}
            target="_blank"
            className="w-[48%] h-36 md:w-[30%] md:h-27 lg:w-[23.5%] lg:h-27 bg-theme1CardBg cursor-pointer border-2 border-theme1CardBorder ease-in-out duration-300 hover:border-theme1CardBorderHover rounded-lg shadow-md"
          >
