    ...
    >
      <div className="mt-8 md:mt-10 flex flex-wrap justify-start items-center gap-y-7 md:gap-y-7 lg:gap-y-6 gap-x-[4%] md:gap-x-[4%] lg:gap-x-[2%]">
        {media.map((media) => (
          <Link
            key={media.id}
            className="w-[48%] h-36 md:w-[30%] lg:w-[15%] lg:h-27 bg-color13 cursor-pointer border-2 border-color11 ease-in-out duration-300 hover:border-color12 rounded-lg shadow-md"
            href={media.url}
            target="_blank"
          >
