    ...
    return (
      <Link href="/subscription" target="_blank">
        <button className={`relative group z-0 ${width}`}>
          <div className="rounded-full bg-transparent px-4 py-2 transition-colors duration-300 hover:bg-gray-800 border-[1.5px] border-theme1Light1">
  ...
  return (
    <Link href="/subscription" target="_blank">
      <button className={`relative group z-0 ${width}`}>
        ...
        <div className="m-[1.5px] rounded-full bg-theme1Dark1 px-4 py-2 transition-colors duration-300 hover:bg-gray-800">
