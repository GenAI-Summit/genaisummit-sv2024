  ...
  const terms = [
    {
      title: "Introduction",
      paragraphs: [
        "1.1 This website (\"Website\") is operated by GenAI X, Inc. (GPT DAO), the organizer of the summit.",
        ...
        "1.3 GenAI X, Inc. (GPT DAO) may revise these Terms & Conditions at any time by posting an update on the Website. Your continued use of the Website after any such change constitutes your acceptance of the new Terms & Conditions. These Terms & Conditions were last updated in July 2024. GenAI X, Inc. (GPT DAO) reserves the right to change these Terms & Conditions at any time.",
        "1.4 GenAI X, Inc. (GPT DAO) reserves the right to refuse admission to the summit for any behavior, which it deems unacceptable, or for breach of these Terms & Conditions.",
      ],
    },
    {
      title: "Data Protection and Privacy Policy",
      paragraphs: [
        "2.1 By providing your details, you agree to allow GenAI X, Inc. (GPT DAO) and companies associated with this event to contact you (by mail, email, telephone or fax) regarding their services. If you do not wish to receive such communications please contact us in writing at gptdao@genaix.ai.",
        "2.2 By registering for a ticket, you agree to allow us to use your registered company logo for marketing purposes. This includes displaying your logo on our website, social media, and marketing materials. We may adjust the size, format, or placement of your logo as needed. You confirm that you have the authority to grant this permission and that it does not violate any third-party rights. If you have any concerns, please contact us at gptdao@genaix.ai.",
        "2.3 The provision of personal information by you and use of it by GenAI X, Inc. (GPT DAO) is subject to GenAI X, Inc. (GPT DAO)'s Privacy Policy.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "4.1 GenAI X, Inc. (GPT DAO) may collect data from you in the course of purchasing and or registering for tickets sold by GenAI X, Inc. (GPT DAO). You give your permission for your user account details to be stored and acknowledge that you may provide GenAI X, Inc. (GPT DAO) a reasonable timeframe to remove your details at any time that you no longer wish them to be stored. You acknowledge and accept that your data will be used for commercial purposes in accordance with our Data Protection Policy and Declaration of Consent and will be retained and stored for this purpose. Should you wish your data to be removed you must request GenAI X, Inc. (GPT DAO) to do so in writing. Requests can be emailed to gptdao@genaix.ai.",
    ...
    },
    {
      ...
      paragraphs: [
        "5.1 All purchases of tickets for the summit are non-refundable in their entirety. Your ticket remains the property of GenAI X, Inc. (GPT DAO) and is a personal revocable license, which may be withdrawn, and admission refused at any time upon a refund of the printed registration price.",
        "5.2 If for any reason GenAI X, Inc. (GPT DAO) decides to cancel this event, GenAI X, Inc. (GPT DAO) accepts no responsibility for covering airfare, hotel or other costs incurred by registrants, including delegates, sponsors, speakers and guests.",
        "5.3 No refunds will be issued for cancellations due to weather or other causes beyond the Registrant's control. In the unlikely event of cancellation of the summit by GenAI X, Inc. (GPT DAO), the liability of GenAI X, Inc. (GPT DAO) is limited to the share of paid registration fees that remains after credit card and payment processing fees have been incurred and deducted.",
        ...
        "5.5 For questions about registration or assistance with any registration problems, please contact us at gptdao@genaix.ai.",
      ],
    },
    {
      title: "Exhibitor Information",
      paragraphs: [
        "6.1 GenAI X, Inc. (GPT DAO) will not provide transport or travel expenses to or from the summit. GenAI X, Inc. (GPT DAO) will consider but not guarantee exhibitors' requests for day changes at the summit.",
    ...
    },
    {
      ...
      paragraphs: [
        "7.1 GenAI X, Inc. (GPT DAO) will not be liable for any loss injury or damage to any person or property howsoever caused (save for death or personal injury as a result of GenAI X, Inc. (GPT DAO)'s negligence or for any other type of liability that cannot by law be excluded or limited.)",
        "7.2 GenAI X, Inc. (GPT DAO) will not be liable for the granting of any visas that are required to attend the summit. In the event that an attendee's visa is not granted tickets will not be refunded.",
        "7.3 Please note that while speakers and topics are confirmed at the time of publishing, circumstances beyond the control of GenAI X, Inc. (GPT DAO) may necessitate substitutions, alterations or cancellations of the speakers and/or topics. As such, GenAI X, Inc. (GPT DAO) reserves the right to alter or modify the advertised speakers and/or topics if necessary without any liability to you whatsoever. Any substitutions or alterations will be updated on our website as soon as possible.",
      ],
    },
    {
      title: "Indemnity",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "10.3 These Terms & Conditions shall be governed by the laws of the jurisdiction where GenAI X, Inc. (GPT DAO) is registered, and the courts of that jurisdiction shall have exclusive jurisdiction.",
      ],
    },
    {
      title: "Disclaimer",
      paragraphs: [
        "While GenAI X, Inc. (GPT DAO) endeavors to ensure that the Website is normally available 24 hours a day, it shall not be liable if for any reason the Website is unavailable at any time or for any period. Access to the Website may be suspended temporarily and without notice in the case of system failure, maintenance or repair or for any other reasonable cause.",
        "You acknowledge that information on the Website and any related material provided to you by GenAI X, Inc. (GPT DAO), is provided only for general information. GenAI X, Inc. (GPT DAO) uses reasonable care in publishing materials available on GenAI X, Inc. (GPT DAO) websites, however, does not guarantee their accuracy or completeness. Materials available on GenAI X, Inc. (GPT DAO) websites are provided \"as is\" with no warranty, express or implied, and all such warranties are hereby disclaimed. GenAI X, Inc. (GPT DAO) assumes no liability for any loss, damage or expense from errors or omissions in the materials available on GenAI X, Inc. (GPT DAO) websites, whether arising in contract or otherwise.",
      ],
    },
  ];
  return (
