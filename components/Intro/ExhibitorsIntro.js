...
const ExhibitorsIntro = () => {
  ...
  const images = ["/images/propaganda/floormap.webp"];
  return (
    <>
      <Intro
        title={title}
...
export default ExhibitorsIntro;
