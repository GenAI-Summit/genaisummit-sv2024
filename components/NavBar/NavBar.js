...
const NavBar = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-1 px-6 py-2 w-[95%] shadow-md rounded-lg bg-theme1Light3 font-semibold text-theme1Gray1 text-sm flex flex-col items-center text-center lg:hidden z-40 text-theme1Dark1 opacity-[98%]">
